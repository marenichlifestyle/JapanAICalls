        ...
        *,
        ...
        if call_language == "ja":
            prompt = (
                ...
                "VIN/stock, mileage, if present. If vehicle_context identifies the vehicle, this can satisfy missing "
                "vehicle/model details from raw_user_goal. Do not normalize or correct vehicle brand/model names unless "
                "the corrected form is explicitly present in vehicle_context. Do not invent facts. If user intent is vague, return "
                "status=needs_goal_clarification, goal_ru=null, and clarification_questions.\n\n"
                "Preserve explicit user instructions from raw_user_goal. If the user says not to ask additional questions, "
                "that means ask only the explicitly requested question(s) or deliver the requested message; do not replace "
                "the user's request with 'no questions'. If raw_user_goal asks to ask whether dealer-to-dealer purchase is "
                "possible, keep that question in goal_ru.\n\n"
                "Ask only questions needed for the user's stated goal. Add only 1-3 obvious supporting questions when "
                "they directly help complete that goal; do not add a universal dealership questionnaire.\n"
                "Automotive relevance rules: for a specific used vehicle, useful basics can include availability, match "
                "to the listing, condition, history/Carfax-equivalent, title/accidents, documents, and dealer-to-dealer "
                "purchase feasibility. For dealer-to-dealer/no-tax tasks, ask whether they can sell to a dealer/company, "
                "what resale/wholesale/dealer documents are required, and whether the deal can be handled without sales "
                "tax when legally appropriate. Ask about markup/MSRP/market adjustment only for new/order/allocation/rare "
                "incoming vehicles or when the user explicitly asks about price/markup. Ask about fees/tax/OTD/deposit/hold/"
                "paperwork only when the user asks about retail price, out-the-door, taxes/fees, order/reservation, or deal "
                "process. Example: if the user asks to confirm white exterior, white interior, condition, Carfax, and "
                "dealer-to-dealer no tax, do not add markup/MSRP/deposit questions. If the user asks when RAM TRX 2026 "
                "orders open and what pricing/markup will be, then MSRP/markup/allocation questions are relevant.\n"
                "Ask short questions one at a time; if a critical answer is vague, ask one polite follow-up and then accept "
                "unknown/refusal/message request as final for that item.\n\n"
            ...
            prompt = (
                ...
                "VIN/stock, mileage, if present. If vehicle_context identifies the vehicle, this can satisfy missing "
                "vehicle/model details from raw_user_goal. Do not normalize or correct vehicle brand/model names unless "
                "the corrected form is explicitly present in vehicle_context. Do not invent missing facts.\n\n"
                "Preserve explicit user instructions from raw_user_goal. If the user says not to ask additional questions, "
                "that means ask only the explicitly requested question(s) or deliver the requested message; do not replace "
                "the user's request with 'no questions'. If raw_user_goal asks to ask whether dealer-to-dealer purchase is "
                "possible, keep that question in goal_ru.\n\n"
                ...
                "they directly help complete that goal; do not add a universal dealership questionnaire.\n"
                "Automotive relevance rules: for a specific used vehicle, useful basics can include availability, match "
                "to the listing, condition, vehicle history/Carfax, title/accidents, documents, and dealer-to-dealer "
                "purchase feasibility. For dealer-to-dealer/no-tax tasks, ask whether they can sell to a dealer/company, "
                "what resale/wholesale/dealer documents are required, and whether the deal can be handled without sales "
                "tax when legally appropriate. Ask about markup/MSRP/market adjustment only for new/order/allocation/rare "
                "incoming vehicles or when the user explicitly asks about price/markup. Ask about fees/tax/OTD/deposit/hold/"
                ...
                "configuration, or availability. If the vehicle is known but the user did not provide what to ask, "
